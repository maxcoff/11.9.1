...
class WSMonitor:
    ...
    async def _handle_message(self, msg: dict) -> None:
        ...
        key = (ch, msg.get("arg", {}).get("instId"))
        if key in self._ext_listeners:
            try:
                self._ext_listeners[key](msg)   # передаём целиком, нах
            except Exception:
    ...
    def subscribe(self, channel: str, inst_id: str, callback: Callable[[dict], None]) -> None:
        """
