...
from core.config import get, get_int, get_float 


print(">>> LOG_TZ_OFFSET =", float(get("LOG_TZ_OFFSET", "3") or "3"))
print(">>> LOG_TZ_OFFSET =", get_float("LOG_TZ_OFFSET", 3) or 3)

# читаем смещение в часах из env (можно задавать +3, -5 и т.д.)
TZ_OFFSET_HOURS = float(get("LOG_TZ_OFFSET", "3")or "3")
