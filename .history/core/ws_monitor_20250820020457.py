...
class WSMonitor:
    ...
    async def get_mark_price_for_position(self, inst: str) -> float:
        async with self._lock:
            return self.mark_prices.get(inst, 0.0)
    
    def get_mark_price(self, inst: str) -> float:
        return self.mark_prices.get(inst, 0.0)
