...
from typing import Optional, Dict, Tuple, Callable, List, Any, Awaitable, Coroutine
...
class WSMonitor:
    ...
    async def connect(self) -> None:
        ...
        if not self._running:
            self._running    = True
            self._task_priv  = create_tracked_task(self._run_private(),"ws_privat")
            self._task_pub   = create_tracked_task(self._run_public(), "ws_public")
