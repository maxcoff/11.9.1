...
from core.task_tracker import poll_tracked_tasks, start_task, stop_task
...
async def ws_log(ws: WebSocket):
    ...
    try:
        while True:
            ...
            await ws.send_text(json.dumps({"type": "tasks", "data": poll_tracked_tasks()}, ensure_ascii=False))
    except WebSocketDisconnect:
