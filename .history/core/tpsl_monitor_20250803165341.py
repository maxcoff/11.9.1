...
class TpslMonitor:
    ...
    def on_fill_event(self, ev: Any) -> None:
        ...
        print(f"[TPSL] on_fill_event called, init_px={self.init_px}, init_qty={self.init_qty}")
        ...
        if cid != self.init_cid or fill_px <= 0:
            #debug
            print(f"[TPSL]1 on_fill_event: self.entry_cid={self.init_cid}, is not, cid={cid}, - ignoring event , fill_px={fill_px},")
            return
