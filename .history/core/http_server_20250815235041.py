...
from core.task_tracker import list_tracked_tasks
...
async def ws_log(ws: WebSocket):
    ...
    try:
        while True:
            ...
            # Если клиент запросил обновление
            if msg:
                try:
