...
class ReinvestManager:
    ...
    # ------------------------------------------------------------------
    async def handle_tp_fill(self, snapshot: Tuple[Decimal, Decimal, Decimal]):
        """
    ...
    # Внутренние шаги
    # ------------------------------------------------------------------
    async def _do_reinvest(self, snapshot: Tuple[Decimal, Decimal, Decimal]):
        ep, eq, tp = map(Decimal, snapshot)
