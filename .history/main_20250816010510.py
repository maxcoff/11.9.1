...
from core.task_tracker import init_task_tracker
...
async def main():
    ...
    # пишем loop id основного потока, потому что веб сервер работает в другом и не видит этого
    loop = asyncio.get_running_loop()
    init_task_tracker(loop)
